...
const ContactForm = ({ willShow, onClose }: Props) => {
  return (
    <div className={willShow ? 'block' : 'hidden'}>
      <div className="fixed top-0 left-0 right-0 left-0 bottom-0 opacity-75 bg-black z-50"></div>
